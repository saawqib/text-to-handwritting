 ...
 *
 * If you have any questions related to code, you can drop them in my Twitter DM @sawwqibcodes
 * or in my email at sawwqib99@gmail.com
 *
...
fetch(
  'https://api.github.com/repos/sawwqib/text-to-handwriting/contributors'
)
  .then((res) => res.json())
  .then((res) => {
